...
for (const file of [
  "index.html", "scan.html", "records.html", "stock.html", "alerts.html", "policy.html", "sanitation.html", "sanitation-list.html", "app.js", "styles.css", "runtime-config.js", "manifest.webmanifest", "sw.js",
]) await copy(file);
